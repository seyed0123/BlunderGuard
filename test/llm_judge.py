...
def main():
    parser = argparse.ArgumentParser(
        description=(
            "Compare a generated TSV against test_dataset.tsv and judge each "
            "generated analysis with a local OpenAI-compatible model."
        )
    )
    parser.add_argument("--input", required=True, help="generated/candidate TSV")
    parser.add_argument(
        "--reference",
        default=str(Path(__file__).with_name("test_dataset.tsv")),
        help="reference TSV (default: test/test_dataset.tsv)",
    )

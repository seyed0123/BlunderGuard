...
OUTPUTS = {
    "beginner": EVALUATION_DIR / "beginner" / "beginner.json",
    "intermediate": EVALUATION_DIR / "intermediate" / "intermediate.json",
    "advanced": EVALUATION_DIR / "advanced" / "advanced.json",
}
